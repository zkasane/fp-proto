...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center mb-5">Grand Merak Hotel</h2>
            <div class="row">
                <div class="col-md-6 mx-auto card-holder">
                    <div class="card border-secondary">
                        <div class="card-header">
                            <h3 class="mb-0 my-2">Registrasi Akun</h3>
                        </div>
                        <div class="card-body">
                            <form class="form" role="form" autocomplete="off" id="registration-form" method="post">
                                ...
                                <div class="form-group">
                                    <label for="registrationPhoneNumber">Nomor Telepon</label>
                                    <input type="text" class="form-control"
                                ...
                                <div class="form-group">
                                    <label for="registrationPassword2">Konfirmasi Password</label>
                                    <span class="red-asterisk"> *</span>
                                    <input type="password" class="form-control"
                                ...
                                <div class="form-group">
                                    <p>Sudah ada Akun? <a href="sign-in.php">Masuk</a></p>
                                </div>
                                <div class="form-group">
                                    <a  href="index.php" class="btn btn-dark">Kembali</a>
                                    <input type="submit" class="btn btn-primary btn-md float-right"
                                            name="registerSubmitBtn" value="Registrasi">
                                </div>
                            </form>
                        </div>
                    </div>
